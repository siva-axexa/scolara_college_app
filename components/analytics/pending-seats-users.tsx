...
function stageToProgress(stage: SeatStage): number {
  ...
  if (idx < 0) return 0
  const steps = STAGES.length - 1 // 0..3 => 4 stages => 3 transitions
...
// Example mock users. Replace with your real data when ready.
...
export default function PendingSeatsByUser() {
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-base md:text-lg">Pending Seats</CardTitle>
      </CardHeader>
