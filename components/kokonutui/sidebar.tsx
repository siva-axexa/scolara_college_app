              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4 w-4 transition-transform ${adminOpen ? "rotate-180" : "rotate-0"}`} />
                  </button>
                  {adminOpen && (
                    <div className="mt-1 space-y-1 pl-8">
                      <NavItem href="/admin?section=phones" icon={Phone}>
                        Logged-in Phones
                      </NavItem>
                      <NavItem href="/admin?section=users" icon={Users2}>
                        Users
                      </NavItem>
                      <NavItem href="/admin?section=applications" icon={FileText}>
                        Applications
                      </NavItem>
                      <NavItem href="/admin?section=support" icon={MessagesSquare}>
                        Support & Chat
                      </NavItem>
                      <NavItem href="/admin?section=policies" icon={ScrollText}>
                        Policies & Push
                      </NavItem>
                    </div>
                  )}
                  <NavItem href="/approved" icon={BadgeCheck}>
                    Approved
                  </NavItem>
